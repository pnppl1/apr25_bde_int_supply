...
Organizing the data into a SQL database using Postgresql and Docker. We implement a schema regarding our Diagram and insert the tables given our scraped data. 
